        ...
        <main>
            <section>
                <form action="<?php echo $_SERVER["PHP_SELF"]?>" method="POST">
                    ...
                    <input type="text" label="user_password" name="user_password" placeholder="Contraseña" value="<?php echo $user["user_password"] ?>" required/>
                    <input type="hidden" name="user_id" value="<?php echo $user["user_id"] ?>" required/>
                    <a class="btn" href="index.php">Cancelar</a>
                    <a class="btn" href="http://localhost/crud-app-php/src/views/users/update.php">Reset</a>
